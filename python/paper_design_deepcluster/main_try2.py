...
def parse_args():
    ...
    parser.add_argument('--resume', default=r'/home/jijl/My_project/paper_design_deepcluster/check', type=str,
                        metavar='PATH',
                        help='path to checkpoint (default: None)')
    parser.add_argument('--checkpoints', type=int, default=25000,
                        help='how many iterations between two checkpoints (default: 25000)')
    parser.add_argument('--exp', type=str, default=r'/home/jijl/My_project/paper_design_deepcluster/check',
...
def main(args):
    ...
    dataset = datasets.ImageFolder(root=r'/home/jijl/My_project/paper_design_deepcluster/sdsds',
