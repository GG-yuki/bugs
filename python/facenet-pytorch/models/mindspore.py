...
env()#设置运行环境，目前是使用cpu，可进入support文件修改
...
class pNet(nn.Cell):
    def __init__(self, pretrained=True):
        ...
        self.ceil = mindspore.ops.operations.Ceil()
...
class RNet(Module):
    ...
    def __init__(self, pretrained=True):
        ...
        self.ceil1 = mindspore.ops.operations.Ceil()
        self.conv2 = Conv2d(28, 48, kernel_size=3)
        self.prelu2 = PReLU(48)
        self.pool2 = MaxPool2d(3, 2)
        self.ceil2 = mindspore.ops.operations.Ceil()
        self.conv3 = Conv2d(48, 64, kernel_size=2)
        self.prelu3 = PReLU(64)
        self.dense4 = fc(576, 128)
        self.prelu4 = PReLU(128)
        self.dense5_1 = fc(128, 2)
        self.softmax5_1 = Softmax(1)
        self.dense5_2 = fc(128, 4)
...
class ONet(Module):
    ...
    def __init__(self, pretrained=True):
        ...
        self.prelu4 = PReLU(128)
        self.dense5 = fc(1152, 256)
        self.prelu5 = PReLU(256)
        self.dense6_1 = fc(256, 2)
        self.softmax6_1 = Softmax(dim=1)
        self.dense6_2 = fc(256, 4)
        self.dense6_3 = fc(256, 10)
...
class MTCNN(Module):
    ...
    def forward(self, img, save_path=None, return_prob=False):
        ...
        than the bounding boxes. To access bounding boxes, see the MTCdetect() method below.
    ...
    def detect(self, img, landmarks=False):
        ...
        >>> boxes, probs, points = mtcdetect(img, landmarks=True)
