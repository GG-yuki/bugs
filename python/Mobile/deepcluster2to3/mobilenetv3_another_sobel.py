...
class MobileNetV3(nn.Module):
    ...
    def __init__(
        ...
        layers.append(ConvBNActivation(2, firstconv_output_channels, kernel_size=3, stride=2, norm_layer=norm_layer,
        ...
        self.top_layer = nn.Linear(last_channel, num_classes)
